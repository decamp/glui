...
def make_plist(options, name, main_class, resource_path, stub_path, icon_path, plist_path):
	...
	txt = txt.replace('%%INFO%%', name + ' Copyright 2009 Massachusetts Institute of Technology')
...
# Generates shell script to use in place of application stub.
	...
	out_file.write('JAVA="/System/Library/Frameworks/JavaVM.framework/Versions/1.5/Commands/java"\n')
