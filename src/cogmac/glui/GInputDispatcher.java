...
public class GInputDispatcher {
    ...
    private GComponent mMousePrevButtonFocus = null;
    ...
    public void translateMousePressedEvent(MouseEvent e, int ex, int ey) {
        ...
        if(mMouseButtonFocus != null) {
            ...
            if( mMouseButtonFocus != mFocus &&
                mMouseButtonFocus.isRequestFocusEnabled() &&
                GToolkit.isFocusable(mMouseButtonFocus) )
            {
                processFocusRequest(mMouseButtonFocus);
            }
        }
    }
    ...
    public void translateMouseReleasedEvent(MouseEvent e, int ex, int ey) {
        ...
        if(mMouseButtonFocus != null) {
            ...
            if((e.getModifiersEx() & ALL_BUTTON_MASK) == 0) {
                mMousePrevButtonFocus = mMouseButtonFocus;
    ...
    public void translateMouseClickedEvent(MouseEvent e, int ex, int ey) {
        ...
        if(mMousePrevButtonFocus != null) {
            resendMouse(e, MouseEvent.MOUSE_CLICKED, mMousePrevButtonFocus);
        }
    }
