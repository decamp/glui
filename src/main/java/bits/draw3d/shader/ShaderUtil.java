...
public class ShaderUtil {
    ...
    public static final String ATT_NORMAL     = "inNorm";
    public static final String ATT_TEX_COORD0 = "inTex0";
    public static final String ATT_TEX_COORD1 = "inTex1";
    public static final String ATT_TEX_COORD2 = "inTex2";
    public static final String ATT_VERTEX     = "inVert";
